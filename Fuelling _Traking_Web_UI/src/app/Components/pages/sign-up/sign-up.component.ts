...
IsAccountCreated: boolean = false;
  Submint(){
    ...
    this.loginAuth.Save_Customer_Req([
      ...
      if(res == '201')
      {
        this.toast.success({detail:"SUCCESS",summary:'Successfully created!',duration:5000});
        this.IsAccountCreated = true;
      }
      else if(res =='415')
      {
        this.toast.error({detail:"ERROR",summary:'Already used the registration number',sticky:true});
